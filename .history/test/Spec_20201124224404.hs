...
libhelper = describe "LibHelper" $ do
    ...
    describe "getNextPowerOf2 : " $ do
        it "returns next power of 2 for 12421" $ getNextPowerOf2 12421 `shouldBe` 8
    describe "padNumberBeforeWithZeroes : " $ do
        it "returns number of zeroes to pad before 12421" $  padNumberBeforeWithZeroes 12421 `shouldBe` 3
    describe "get2ndHalf : " $ do
        it "returns 2nd half for karatsuba 32421" $  get2ndHalf 32421 `shouldBe` 2421
libadvanced :: Spec
