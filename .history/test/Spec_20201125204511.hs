...
libhelper = describe "LibHelper" $ do
    ...
    describe "get2ndHalf : " $ do
        it "returns 2nd half for karatsuba -151" $ get2ndHalf (-151) 2 `shouldBe` 51
    describe "get1stHalf : " $ do
      it "returns 1st half for karatsuba -151" $ get1stHalf (-151) 51 `shouldBe` (-1)
    describe "get1stHalf : " $ do
        it "returns 1st half for karatsuba -2151" $ get1stHalf (-2151) 51 `shouldBe` (-21)
