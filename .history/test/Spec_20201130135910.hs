...
libhelper = describe "LibHelper" $ do
    ...
    describe "karatsuba : 23456789012446467373777181818137373728282828 * 183653535354747464628282828283838383839393939393939 " $ do
        it "returns karatsuba 23456789012446467373777181818137373728282828 * 183653535354747464628282828283838383839393939393939 " $ karatsuba 23456789012446467373777181818137373728282828 183653535354747464628282828283838383839393939393939 `shouldBe` (23456789012446467373777181818137373728282828 * 183653535354747464628282828283838383839393939393939)
...
libProperty = describe "LibProperty" $
    describe "prop_4  " $ do
        it "karatsuba x y " $ property $
            \f s -> f > 1000000 ==> s > 10000000 ==> (karatsuba f s == (f * s))
...
prop_3 f s = f > 0 ==> s > 0 ==> (karatsuba f s == (f * s))
