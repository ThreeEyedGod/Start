...
prop_3 :: Large Integer -> Large Integer -> Property 
prop_3 (Large f) (Large s) = f > 100000000000000000000000 ==> s > 100000000000000000000000 ==> collect (num_digits f) $ (karatsuba f s == (f * s))
